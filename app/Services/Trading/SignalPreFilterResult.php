...
/**
 * SignalPreFilterResult
 *
 * Immutable value object returned by SignalPreFilterService when a coin passes
 * all pre-filter rules.
 *
 ...
 */
readonly class SignalPreFilterResult
{
    /**
     ...
     * @param  int  $score  Cumulative score (must be >= 1 to pass)
